  ...
  if(Token=="ply"){
    ...
    if(Token=="format"){
      ...
      if(Token=="ascii"){
        ...
        if(Token=="vertex"){
          get_token(Line_stream,Token);
          Coordinates.resize(stoi(Token)*3); //vertices, multiplica por 3 puesto que trabajamos con 3 coordenadas.
          do{
            get_new_line(File,Line_stream);
            get_token(Line_stream,Token);
          } while (Token!="element");
          ...
          if(Token=="face"){
            get_token(Line_stream,Token);
            Positions.resize(stoi(Token)*3); //caras, multiplica por 3 puesto que trabajamos con triangulos (un punto para cada vertice del triangulo).
            do{
              get_new_line(File,Line_stream);
              get_token(Line_stream,Token);
